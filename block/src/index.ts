...
export type MixcrScfvClonotypingBlockContract = BlockContract;
export type MixcrScfvClonotypingBlockOutputs  = BlockOutputs;
export type MixcrScfvClonotypingBlockData     = BlockData;
export const MixcrScfvClonotypingBlockPointer = BlockPointer;
